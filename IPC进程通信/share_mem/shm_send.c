 ...
 * @LastEditTime: 2019-02-09 23:18:12
...
int main(int argc, char const *argv[])
{
    ...
    //分配sem对象
    sem_id = semget(IPC_PRIVATE, 1, IPC_CREAT | 0666) if (sem_id < 0)
    ...
    //分配一段共享内存,仅仅自己读写
    shm_id = shmget(IPC_PRIVATE, getpagesize, IPC_CREAT | 0600);
    if (shm_id < 0)
